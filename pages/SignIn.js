            ...
            <View style={styles.mainContainer}>
                ...
                <View>
                    ...
                    <TextInput
                        ...
                        style={[styles.textInp, styles.textInpPwd, this.state.isFocusedPwd ? styles.textInpFocus : styles.textInpBlur]}
                ...
                <Pressable onPress={(this.state.emailVal != "" && this.state.pwdVal != "") ? this.onClickHandle : () => { alert('All field must be filled') }}><View style={styles.signInBtn}><Text style={styles.signInBtnText}>SIGN IN</Text></View></Pressable>
                    <Pressable onPress={() => { console.log('forgot pwd page') }}><Text style={styles.forgotPwdText}>Forgot your password?<Text style={styles.reset}> Reset here</Text></Text></Pressable>
                </View>
